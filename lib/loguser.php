...
// Default, IP ban when "account IP-banned" is enabled"
...
// IP-ban when an account is banned
/* if($loguser['powerlevel'] = > 0)
{
	Query("INSERT INTO {ipbans} (ip,reason,date) VALUES ({0},{1},0)",
		$_SERVER['REMOTE_ADDR'], '['.htmlspecialchars($loguser['name']).'] Your account is banned. ');
	die(header('Location: '.$_SERVER['REQUEST_URI']));
} */
