	...
	<table id="header" class="outline">
		<tr>
			<td class="cell0 left">
				...
				<tr>
				<td>
					<a href="{actionLink page='home'}"><img id="theme_banner" title="{$title}" src="{$layout_logopic}" alt="{$boardname}" title="{$boardname}"></a>
				</td>
				<td>
...
<td id="main-page">
	...
	<tr><td class="crumb-container crumbContTop"> <!--- Why is crumbContTop/Bottom here? So you can use Slatebit themes if you wanted to. --->
...
<td id="main-footer" colspan="2">
	...
	<td class="cell2">
      ...
      {$perfdata}
      <!--- Blargboard layout made by StapleButter. Not a good layout on 4x3 screens. --->
			</td>
		</table>
	</td>
	</tr>
